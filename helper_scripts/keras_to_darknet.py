...
parser = argparse.ArgumentParser("Convert from keras YOLO .xml version to darknet .txt format")
parser.add_argument("base_path", help="Base path with images and labels", default = home_directory + "/data")
parser.add_argument("put_path", help="Put path to place images and labels", default = home_directory + "/put_data")
parser.add_argument("data_type", help="Type of data, either train, testm or val")
parser.add_argument("folder_name", help="Name of image folders under based directory. Must have acompanying labels folder (e.g. train_images)")


args = parser.parse_args()
base_path = args.base_path
put_path = args.put_path
data_type = args.data_type
folder_name = args.folder_name

base_folder = base_path + '/' + folder
put_folder = put_path + '/'
'''
